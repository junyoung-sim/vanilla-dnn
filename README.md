...
As an example, a neural network with 1M+ parameters was trained to estimate the mean and variance of a randomly generated path that follows geometric Brownian motion. For testing purposes, the neural network was updated 10 times given a batch with 10 samples.
